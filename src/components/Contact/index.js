...
function Contact(props) {
    ...
    return (
        <div className='flex-row px-0 sm:px-10 invert opacity-60 shrink' >
            <a className='px-2 shrink fill-transparent' target="_blank" rel='noreferrer' href="https://www.linkedin.com/in/reagan-bodily-06696b174/">
            ...
            <a className='px-2 shrink fill-transparent' target="_blank" rel='noreferrer' href="https://github.com/Rbodil">
            ...
            <a className='px-2 shrink fill-transparent' target="_blank" rel='noreferrer' href="mailto:reaganbodily@gmail.com">
            ...
            <a className='px-1 shrink fill-transparent' target="_blank" rel='noreferrer' href="tel:385-630-5348">
